            ...
            if (isAllDump) {
                ...
                Runnable checkMd5Task = () -> {
                    ...
                    for (String groupKey : diffList) {
                        ...
                        ConfigCacheService.dumpChange(dataId, group, tenant, new String(configInfo.getContent()),
            ...
            for (ConfigInfoChanged configInfo : configInfoList) {
                ...
                try {
                    ...
                    if (datumList.size() > 0) {
                        ...
                        String aggrContent = new String(cf.getContent());
                        ...
                        if (!StringUtils.equals(localContentMD5, aggrConetentMD5)) {
                            ...
                            LOGGER.info("[merge-ok] {}, {}, size={}, length={}, md5={}, content={}", dataId, group,
                                    datumList.size(), new String(cf.getContent()).length(), cf.getMd5(),
                                    ContentUtils.truncateContent(new String(cf.getContent())));
                        }
                    } else {
                        // remove config info
