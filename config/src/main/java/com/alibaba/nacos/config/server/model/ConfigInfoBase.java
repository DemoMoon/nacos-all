...
public class ConfigInfoBase implements Serializable, Comparable<ConfigInfoBase> {
    ...
    public void dump(PrintWriter writer) {
        writer.write(new String(this.content));
    }
    ...
    public int compareTo(ConfigInfoBase o) {
        ...
        if (this.content == null) {
            ...
            if (o.getContent() == null) {
                ...
                int cmpContent = new String(this.content).compareTo(new String(o.getContent()));
                if (cmpContent != 0) {
                    return cmpContent;
                }
            }
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((content == null) ? 0 : new String(content).hashCode());
